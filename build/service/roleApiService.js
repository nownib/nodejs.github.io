...
var _index = require("sequelize/dist/index.js");
...
var createNewRole = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(roles) {
    var currentRoles, persists;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _index2["default"].Role.findAll({
        ...
        case 8:
          _context.next = 10;
          return _index2["default"].Role.bulkCreate(persists);
        case 10:
          return _context.abrupt("return", {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return _index2["default"].Role.findOne({
            where: {
              id: id
            },
            raw: false,
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.prev = 0;
          _context5.next = 3;
          return _index2["default"].Group_Role.destroy({
            where: {
        ...
        case 3:
          _context5.next = 5;
          return _index2["default"].Group_Role.bulkCreate(data.groupRoles);
        case 5:

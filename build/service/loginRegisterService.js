...
var registerNewUser = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(rawUserData) {
    var isEmailExist, isPhoneExist, hashPassword;
...
var checkPassword = function checkPassword(inputPassword, hashPassword) {
  return _bcryptjs["default"].compareSync(inputPassword, hashPassword); //true or false
};
var handleUserLogin = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(rawData) {
    var user, isCorrectPassword, groupWithRoles, payload, token;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _context4.next = 3;
          return _index["default"].User.findOne({
            where: _defineProperty({}, _sequelize2.Op.or, [{
